...
undum.game.situations = {
    ...
    instrucciones: new undum.SimpleSituation(
            "<h1 class='transient'>ANTES DE EMPEZAR...</h1></br>\
	<p class='transient'>Esta aventura gráfica se ha diseño para jugarla a pantalla completa y con el sonido\
	del navegador habilitado. Para obtener la mejor experiencia de usuario deberás habilitar\
	las dos opciones mencionadas.</p></br>\
	<p class='transient'><a href='inicio'>¡OK, Comenzar la aventura!</a></p></br>"
            ),
		...
		<p class='transient'><a href='inicio' class='once'>Volver al distribuidor</a></p></br>",
            {
				...
				detenimiento y descubres que se han dejado una <a class='once' href='./nota'>nota</a></p></br>",

                    'nota': function (character, system, to) {
                        system.write("<p>Coges la nota y está algo requemada por lo que no se puede leer todo\
				           su contenido, pero puedes leer un párrafo: El intercabio será en el\
						    callejón del crimen.</p></br>");
                        system.setCharacterText("<p>¡¡Nueva localización desbloqueada!!</p>");
                    },
                    ...
                    'entregar_sustancia': function (character, system, to) {
                        ...
                        system.write("<p>-¿Qué puedes decirme de esto?. Dices tras depositar en su escritorio la bolsa con la\
                                      sustancia que encontraste en Park Row. Lo tenía uno de los cadáveres de Park Row.\
                                        ...
                                        <p class='transient'><a class='once' href='./responder1'>responder</a></p></br>");
                    },

                    'responder1': "<p>-Está claro que el soplo se equivocaba. Con Crane subimos de nivel.\
                                        </p></br>\
                                        ...
                                        <p class='transient'><a class='once' href='./responder2'>responder</a></p></br>",

                    'responder2': "<p>-James, esta noche han atacado mi guarida. No sé quién ni por qué pero no dispongo de los\
                                       ...
                                       <p class='transient'><a class='once' href='./responder3'>responder</a></p></br>",

                    'responder3': "<p>-No por mucho tiempo. Dices decidido. Esta noche se acabó, ¿Dónde puedo encontrarle?.\
                                       </p></br>\
                                       ...
                                       <p class='transient'><a class='once' href='./responder4'>responder</a></p></br>",

                    'responder4': "<p>-Ya lo veremos.</p></br>\
                                      <p><a href='nodo_batmovil'>Volver al batmovil.</a></p></br>"
    ...
    comisaria1: new undum.SimpleSituation(
		...
		<p>-¡¿Qué demonios haces aquí?! ¡¡No hay tiempo que perder maldita sea!! ¡¡Largo de aquí!!\
                ...
                <p class='transient'><a href='nodo_batmovil'>Volver al batmovil.</a></p></br>"
            ),
    ...
    saloniceberg: new undum.SimpleSituation(
        ...
        <p class= 'transient'><a class='once' href='./responder'>responder</a></p></br>",
            {
                enter: function (character, system, to) {
                    if (salon == 0) {
                        salon++;
        ...
        <p class='transient'><a class='once' href='./responder'>responder</a></p></br>",
            {
               ...
               <p class='transient'><a href='saloniceberg2'>Volver al batmovil.</a></p></br>",
                }
            }
		...
		</p></br>",
            {
                actions: {
                    'recogerllavesala': function (character, system, to) {
                        ...
                        system.write("<p>es la que desbloquea la cerradura!<a href='./abrirpuerta'> Abrir la cerradura con la llave.</a></p></br>");
                    },

                    'abrirpuerta': function (character, system, to) {
                        system.setQuality("llaveSala", 0);
                        system.write("<p>Abres la puerta con cautela, pero para tu sorpresa te encuentras con que no \
				está allí tu objetivo. Así, inmediatamente, <a href='irbanio'>te diriges al baño.</a></p></br>");
                    }
                }
            }
    ),
    ...
    dejarquehable: new undum.SimpleSituation(
        ...
        <p class='transient'><a class='once' href='./responder'>preguntar</a></p></br>",
            {
                actions: {
...
undum.game.start = "instrucciones";
